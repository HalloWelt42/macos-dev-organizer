    ...
    if (href) {
      ...
      if (ytMatch) {
        ...
        return `<div class="yt-thumb-wrap not-prose relative my-3 w-[300px] h-[170px] cursor-pointer rounded-md" data-yt-id="${vid}">
          ...
          <div class="absolute top-2 right-2 z-10 rounded bg-red-600 px-2 py-1 text-xs font-medium text-white leading-none"><i class="fa-brands fa-youtube"></i> YouTube</div>
